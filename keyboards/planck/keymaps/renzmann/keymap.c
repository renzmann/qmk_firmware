...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, KC_LCBR, KC_RCBR, KC_LBRC, KC_RBRC, KC_UNDS, A(KC_F), KC_BSLS, _______, _______, _______, KC_PLUS,
    _______, _______, _______, _______, _______, KC_SPC,           _______, _______, _______, _______, _______, _______
),
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      | <F5> | <F6> | <F7> | <F8> |Qwerty|      | PvTrk| Play | NxTrk|      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    _______, KC_F5  , KC_F6  , KC_F7  , KC_F8  , QWERTY , _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______,
