...
/* QGMLWY
 * ,-----------------------------------------------------------------------------------.
 * | Tab  |   Q  |   G  |   M  |   L  |   W  |   Y  |   F  |   U  |   B  |   ;  | BkSpc|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | ESC  |   D  |   S  |   T  |   N  |   R  |   I  |   A  |   E  |   O  |   H  |   '  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Shift|   Z  |   X  |   C  |   V  |   J  |   K  |   P  |   ,  |   .  |   /  | Enter|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | Shift| GUI  | Alt  |Lower |    Space    |Raise | Alt  | GUI  |Shift | Ctrl |
 * `-----------------------------------------------------------------------------------'
 */
[_QGMLWY] = LAYOUT_planck_grid(
...
[_RAISE] = LAYOUT_planck_grid(
    _______, _______, _______, KC_LCBR, KC_RCBR, _______, _______, _______, KC_INS , KC_UP  , _______, _______,
    _______, _______, KC_BSPC, KC_LPRN, KC_RPRN, KC_BSPC, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGUP,
    KC_CAPS, _______, KC_DEL , KC_LBRC, KC_RBRC, KC_DEL , _______, _______, KC_HOME, KC_END , _______, KC_PGDN,
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      | <F5> | <F6> | <F7> | <F8> |Qwerty|Qgmlwy| PvTrk| Play | NxTrk|      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    _______, KC_F5  , KC_F6  , KC_F7  , KC_F8  , QWERTY , QGMLWY , KC_MPRV, KC_MPLY, KC_MNXT, _______, _______,
