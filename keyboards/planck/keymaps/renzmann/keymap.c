 ...
 * |      |      |      |  {   |  }   |      |      |      | PgDn |  Up  | PgUp |      |
 * |------+------+------+------+------+------+------+------|------+------+------+------+
 * |      |      | BkSpc|  (   |  )   | Bkspc|      |      | Left | Down | Right|      |
 * |------+------+------+------+------+------+------+------|------+------+------+------+
 * | Caps |      | Del  |  [   |  ]   | Del  |      |      | Home | End  | Ins  |      |
 * |------+------+------+------+------+------+------+------|------+------+------+------+
 * |      |      |      |      |Adjust|    Space    |XXXXXX|      |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_RAISE] = LAYOUT_planck_grid(
    _______, _______, _______, KC_LCBR, KC_RCBR, _______, _______, _______, KC_PGDN, KC_UP  , KC_PGUP, _______,
    _______, _______, KC_BSPC, KC_LPRN, KC_RPRN, KC_BSPC, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______,
    KC_CAPS, _______, KC_DEL , KC_LBRC, KC_RBRC, KC_DEL , _______, _______, KC_HOME, KC_END , KC_INS , _______,
